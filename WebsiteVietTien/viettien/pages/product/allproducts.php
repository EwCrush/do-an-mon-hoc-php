<?php   
    ...
    $sql_danhsach_sp_limit = "SELECT * from sanpham where TrangThai = 'Kích hoạt' $filter_query and tensp like '%$keyword%' ORDER BY giasale $order";
...
<div class="grid__column-10">
    <div class="home-filter">
        ...
        <ul class="home-filter-list">
            <li class="home-filter-item">
                <a href="index.php?action=danhsachsanpham&danhmuc=tatcasanpham&filter=tatca&order=<?php echo $order ?>&trang=1&keyword=<?php echo $keyword?>" class="home-filter-btn <?php if($filter=="tatca") echo 'home-filter-list-selected'?>">Tất cả</a>
            </li>
            <!-- <li class="home-filter-item">
                <a href="" class="home-filter-btn">Mới nhất</a>
            </li> -->
            <li class="home-filter-item">
                <a href="index.php?action=danhsachsanpham&danhmuc=tatcasanpham&filter=danggiamgia&order=<?php echo $order ?>&trang=1&keyword=<?php echo $keyword?>" class="home-filter-btn <?php if($filter=="danggiamgia") echo 'home-filter-list-selected'?>">Đang giảm giá</a>
            </li>
        </ul>
            ...
            <div class="select-price-option">
                <ul class="select-price-list">
                    <li class="select-price-item">
                        <a href="index.php?action=danhsachsanpham&danhmuc=tatcasanpham&filter=<?php echo $filter ?>&order=desc&trang=<?php echo $tranghientai ?>&keyword=<?php echo $keyword?>" class="select-price-item-link <?php if($order=='desc') echo 'price-selected' ?>">Giá cao đến thấp</a>
                        <i class="select-price-item-link-icon fa-solid fa-check"></i>
                    </li>
                    <li class="select-price-item">
                        <a href="index.php?action=danhsachsanpham&danhmuc=tatcasanpham&filter=<?php echo $filter ?>&order=asc&trang=<?php echo $tranghientai ?>&keyword=<?php echo $keyword?>" class="select-price-item-link <?php if($order=='asc') echo 'price-selected' ?>">Giá thấp đến cao</a>
                        <i class="select-price-item-link-icon fa-solid fa-check"></i>
                    </li>
                </ul>
            </div>
        ...
        <div class="select-page">
            ...
            <!-- page-control-btn-disable -->
                <a href="index.php?action=danhsachsanpham&danhmuc=tatcasanpham&filter=<?php echo $filter ?>&order=<?php echo $order ?>&trang=<?php echo $trangtruoc ?>&keyword=<?php echo $keyword?>" class="page-control-btn">
                    <i class="select-page-icon fa-solid fa-angle-left"></i>
                </a>
                <a href="index.php?action=danhsachsanpham&danhmuc=tatcasanpham&filter=<?php echo $filter ?>&order=<?php echo $order ?>&trang=<?php echo $trangtiep ?>&keyword=<?php echo $keyword?>" class="page-control-btn">
    ...
    <div class="home-product">
        <div class="grid__row">
        <?php   
            $sql_danhsach_sp = "SELECT * from sanpham where TrangThai = 'Kích hoạt' $filter_query and tensp like '%$keyword%' ORDER BY giasale $order LIMIT 10 OFFSET $offset";
    ...
    <ul class="home-pagination mainpage-pagination">
        <li class="home-pagination-item">
            <a href="index.php?action=danhsachsanpham&danhmuc=tatcasanpham&filter=<?php echo $filter ?>&order=<?php echo $order ?>&trang=<?php echo $trangtruoc ?>&keyword=<?php echo $keyword?>" class="home-pagination-item-link">
        ...
        ?>  
            <li class="home-pagination-item  <?php if($tranghientai == $i) echo 'home-pagination-item-active' ?>">
                <a href="index.php?action=danhsachsanpham&danhmuc=tatcasanpham&filter=<?php echo $filter ?>&order=<?php echo $order ?>&trang=<?php echo $i ?>&keyword=<?php echo $keyword?>" class="home-pagination-item-link">
                    <?php echo $i ?>
                </a>
            </li>
        <?php      
        ...
        <li class="home-pagination-item">
            <a href="index.php?action=danhsachsanpham&danhmuc=tatcasanpham&filter=<?php echo $filter ?>&order=<?php echo $order ?>&trang=<?php echo $trangtiep ?>&keyword=<?php echo $keyword?>" class="home-pagination-item-link">
